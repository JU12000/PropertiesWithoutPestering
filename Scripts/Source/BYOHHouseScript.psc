...
function BuyProperty()
	...
	bOwnProperty = true
	; remove gold
	If (PWPBYOHJarl.GetActorReference().GetRelationshipRank(Game.GetPlayer()) < 2)
		Game.GetPlayer().RemoveItem(Gold001, PWPBYOHHPCostNoFavor.GetValueInt())
	Else
...
ReferenceAlias Property PWPBYOHJarl  Auto  
