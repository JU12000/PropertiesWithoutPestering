...
;END AUTOCAST
;BEGIN CODE
kmyquest.Purchasehouse(solitudehouse, solitudehousekey, solitudeguide, kmyquest.PWPHPSolitudeNoFavor)
kmyquest.solitudehousevar=1
SetObjectiveDisplayed(20,1)
...
;END AUTOCAST
;BEGIN CODE
kmyquest.Purchasehouse(riftenhouse, riftenhousekey, riftenguide, kmyquest.PWPHPRiftenNoFavor)
kmyquest.riftenhousevar=1
SetObjectiveDisplayed(30,1)
...
;END AUTOCAST
;BEGIN CODE
kmyquest.Purchasehouse(markarthhouse, markarthhousekey, markarthguide, kmyquest.PWPHPMarkarthNoFavor)
kmyquest.markarthhousevar=1
SetObjectiveDisplayed(40,1)
...
;END AUTOCAST
;BEGIN CODE
kmyquest.Purchasehouse(whiterunhouse, whiterunhousekey, whiterunguide, kmyquest.PWPHPWhiterunNoFavor)
kmyquest.whiterunhousevar=1
SetObjectiveDisplayed(10,1)
...
;END AUTOCAST
;BEGIN CODE
kmyquest.Purchasehouse(windhelmhouse, windhelmhousekey, windhelmguide, kmyquest.PWPHPWindhelmNoFavor)
kmyquest.windhelmhousevar=1
SetObjectiveDisplayed(50,1)
